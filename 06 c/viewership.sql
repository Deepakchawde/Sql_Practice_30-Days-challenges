...
select 
	sum(case when device_type = "laptop" then viewership_count else 0 end) as laptop_view,
	 sum(case when device_type in ("tablet","phone") then viewership_count else 0 end) as mobile_view
from viewership ;
