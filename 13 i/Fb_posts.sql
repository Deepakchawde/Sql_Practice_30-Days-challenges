...
select user_id , sum(likes + comments)as engagement
from fb_posts
group by user_id
...
todays date is 2024-02-29
*/
select * from posts

select user_id, count(user_id) as no_of_post,  sum(likes) as total_likes
from posts 
where post_date between "2024-02-22" and "2024-03-01"
group by user_id  
having no_of_post >2