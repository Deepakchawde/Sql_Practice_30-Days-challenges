...
INSERT INTO orders1 (order_id, seller_id, sale_amount) VALUES
(1, 101, 1500.00),
(2, 102, 2200.00),
(3, 103, 1800.00),
(4, 104, 2500.00),
...
select   o.seller_id, sum(o.sale_amount) as total_sales , count(r.return_quantity) as quality
from orders1 as o 
inner join returns1 as r
on o.seller_id = r.seller_id
group by o.seller_id 
order by sum(o.sale_amount) desc , count(r.return_quantity) asc
limit 3
